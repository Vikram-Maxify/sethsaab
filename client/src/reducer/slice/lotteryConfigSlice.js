    ...
    builder
      ...
      .addCase(
        ...
        (state, action) => {
          ...
          if (config) {
            const exists = state.configs.some(
              (item) =>
                item._id === config._id
            );
